...
public class LinkedListCustum<T> {
	...
	public LinkedListCustum<Integer> getValue() {

		Node<T> tmp = first;
		LinkedListCustum<Integer> node=new LinkedListCustum<Integer>();
		while (true) {
			if (tmp == null) {
				break;
			}
	...
	public boolean printValue(int length, String key, LinkedListCustum<String> li) {
		Node<T> nd2 = first;
		while (true) {
			if (nd2 == null) {
				break;
	...
	public int [] convInteger(LinkedListCustum<Integer> li,int len)
    {
...
//                i++;
    ...
    public boolean findIntegerValue(int length, int key, LinkedListCustum<Integer> li2) {
        Node<T> nd2 = first;
        while (true) {
            if (nd2 == null) {
                break;
    ...
    public String [] convString(LinkedListCustum<T> li,int len)
    {
        Node<T> nd2 = li.first;
...
//                i++;
    ...
    public int [] convertInt(LinkedListCustum<Integer> li,int len)
    {
        Node<Integer> nd2 = li.first;
        int [] str=new int[len];
        int i=0;
